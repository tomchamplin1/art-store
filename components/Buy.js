...
export default function Buy({ itemID }) {
  ...
  if (loading) {
    return <ThreeDots color="gray" height={30} />;
  }
  ...
  return (
    <div>
      ...
      {item ? (
        ...
        <button disabled={loading} className="px-3 py-1.5 rounded-3xl bg-blue-800 text-white hover:bg-blue-600" onClick={processTransaction}>
          Buy now →
        </button>
      )}
    </div>
